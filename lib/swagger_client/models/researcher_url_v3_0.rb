...
module SwaggerClient
  class ResearcherUrlV30
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'url-name')
        self.url_name = attributes[:'url-name']
      end
    ...
    def hash
      [created_date, last_modified_date, source, url_name, url, visibility, path, put_code, display_index].hash
    end
