...
module SwaggerClient
  class InvitedPositionSummaryV30
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'department-name')
        self.department_name = attributes[:'department-name']
      end

      if attributes.has_key?(:'role-title')
        self.role_title = attributes[:'role-title']
      end
    ...
    def hash
      [created_date, last_modified_date, source, put_code, department_name, role_title, start_date, end_date, organization, url, external_ids, display_index, visibility, path].hash
    end
