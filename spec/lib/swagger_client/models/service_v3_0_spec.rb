...
# Unit tests for SwaggerClient::ServiceV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceV30' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceV30.new
  end
  ...
  describe 'test an instance of ServiceV30' do
    it 'should create an instance of ServiceV30' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceV30)
    end
  end
