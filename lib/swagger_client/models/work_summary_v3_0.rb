...
module SwaggerClient
  class WorkSummaryV30
    ...
    def hash
      [put_code, created_date, last_modified_date, source, title, external_ids, url, type, publication_date, journal_title, visibility, path, display_index].hash
    end
