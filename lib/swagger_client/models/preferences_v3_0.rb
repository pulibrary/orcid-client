...
module SwaggerClient
  class PreferencesV30
    ...
    def valid?
      locale_validator = EnumAttributeValidator.new('String', ['AR', 'CS', 'DE', 'EN', 'ES', 'FR', 'IT', 'JA', 'KO', 'PT', 'RU', 'ZH_CN', 'ZH_TW', 'XX'])
    ...
    def locale=(locale)
      validator = EnumAttributeValidator.new('String', ['AR', 'CS', 'DE', 'EN', 'ES', 'FR', 'IT', 'JA', 'KO', 'PT', 'RU', 'ZH_CN', 'ZH_TW', 'XX'])
