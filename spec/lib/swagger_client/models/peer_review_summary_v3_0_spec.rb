...
# Unit tests for SwaggerClient::PeerReviewSummaryV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PeerReviewSummaryV30' do
  before do
    # run before each test
    @instance = SwaggerClient::PeerReviewSummaryV30.new
  end
  ...
  describe 'test an instance of PeerReviewSummaryV30' do
    it 'should create an instance of PeerReviewSummaryV30' do
      expect(@instance).to be_instance_of(SwaggerClient::PeerReviewSummaryV30)
    end
  end
