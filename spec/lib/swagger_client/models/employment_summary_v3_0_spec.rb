...
# Unit tests for SwaggerClient::EmploymentSummaryV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmploymentSummaryV30' do
  before do
    # run before each test
    @instance = SwaggerClient::EmploymentSummaryV30.new
  end
  ...
  describe 'test an instance of EmploymentSummaryV30' do
    it 'should create an instance of EmploymentSummaryV30' do
      expect(@instance).to be_instance_of(SwaggerClient::EmploymentSummaryV30)
    end
  end
