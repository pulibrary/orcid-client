...
module SwaggerClient
  class WorkGroupV30
    ...
    def self.swagger_types
      {
        ...
        :'work_summary' => :'Array<WorkSummaryV30>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'work-summary')
        if (value = attributes[:'work-summary']).is_a?(Array)
          self.work_summary = value
        end
      end
    end
    ...
    def hash
      [last_modified_date, external_ids, work_summary].hash
    end
