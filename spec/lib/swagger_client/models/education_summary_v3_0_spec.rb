...
# Unit tests for SwaggerClient::EducationSummaryV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EducationSummaryV30' do
  before do
    # run before each test
    @instance = SwaggerClient::EducationSummaryV30.new
  end
  ...
  describe 'test an instance of EducationSummaryV30' do
    it 'should create an instance of EducationSummaryV30' do
      expect(@instance).to be_instance_of(SwaggerClient::EducationSummaryV30)
    end
  end
