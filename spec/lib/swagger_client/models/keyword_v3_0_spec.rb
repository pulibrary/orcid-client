...
# Unit tests for SwaggerClient::KeywordV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeywordV30' do
  before do
    # run before each test
    @instance = SwaggerClient::KeywordV30.new
  end
  ...
  describe 'test an instance of KeywordV30' do
    it 'should create an instance of KeywordV30' do
      expect(@instance).to be_instance_of(SwaggerClient::KeywordV30)
    end
  end
