...
# Unit tests for SwaggerClient::DistinctionV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DistinctionV30' do
  before do
    # run before each test
    @instance = SwaggerClient::DistinctionV30.new
  end
  ...
  describe 'test an instance of DistinctionV30' do
    it 'should create an instance of DistinctionV30' do
      expect(@instance).to be_instance_of(SwaggerClient::DistinctionV30)
    end
  end
