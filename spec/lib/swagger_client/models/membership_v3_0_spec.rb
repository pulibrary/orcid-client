...
# Unit tests for SwaggerClient::MembershipV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MembershipV30' do
  before do
    # run before each test
    @instance = SwaggerClient::MembershipV30.new
  end
  ...
  describe 'test an instance of MembershipV30' do
    it 'should create an instance of MembershipV30' do
      expect(@instance).to be_instance_of(SwaggerClient::MembershipV30)
    end
  end
