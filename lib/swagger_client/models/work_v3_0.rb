...
module SwaggerClient
  class WorkV30
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'journal-title')
        self.journal_title = attributes[:'journal-title']
      end

      if attributes.has_key?(:'short-description')
        self.short_description = attributes[:'short-description']
      end

      if attributes.has_key?(:'citation')
      ...
      if attributes.has_key?(:'publication-date')
        self.publication_date = attributes[:'publication-date']
      end
      ...
      if attributes.has_key?(:'language-code')
        self.language_code = attributes[:'language-code']
      end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['ANNOTATION', 'ARTISTIC_PERFORMANCE', 'BOOK_CHAPTER', 'BOOK_REVIEW', 'BOOK', 'CONFERENCE_ABSTRACT', 'CONFERENCE_PAPER', 'CONFERENCE_POSTER', 'DATA_SET', 'DICTIONARY_ENTRY', 'DISCLOSURE', 'DISSERTATION_THESIS', 'EDITED_BOOK', 'ENCYCLOPEDIA_ENTRY', 'INVENTION', 'JOURNAL_ARTICLE', 'JOURNAL_ISSUE', 'LECTURE_SPEECH', 'LICENSE', 'MAGAZINE_ARTICLE', 'MANUAL', 'NEWSLETTER_ARTICLE', 'NEWSPAPER_ARTICLE', 'ONLINE_RESOURCE', 'OTHER', 'PATENT', 'PHYSICAL_OBJECT', 'PREPRINT', 'REGISTERED_COPYRIGHT', 'REPORT', 'RESEARCH_TECHNIQUE', 'RESEARCH_TOOL', 'SOFTWARE', 'SPIN_OFF_COMPANY', 'STANDARDS_AND_POLICY', 'SUPERVISED_STUDENT_PUBLICATION', 'TECHNICAL_STANDARD', 'TEST', 'TRADEMARK', 'TRANSLATION', 'WEBSITE', 'WORKING_PAPER', 'UNDEFINED'])
    ...
    def language_code=(language_code)
      validator = EnumAttributeValidator.new('String', ['ab', 'aa', 'af', 'ak', 'sq', 'am', 'ar', 'an', 'hy', 'as', 'av', 'ae', 'ay', 'az', 'bm', 'ba', 'eu', 'be', 'bn', 'bh', 'bi', 'bs', 'br', 'bg', 'my', 'ca', 'ch', 'ce', 'zh_CN', 'zh_TW', 'cu', 'cv', 'kw', 'co', 'cr', 'hr', 'cs', 'da', 'dv', 'nl', 'dz', 'en', 'eo', 'et', 'ee', 'fo', 'fj', 'fi', 'fr', 'fy', 'ff', 'gl', 'lg', 'ka', 'de', 'el', 'kl', 'gn', 'gu', 'ht', 'ha', 'iw', 'hz', 'hi', 'ho', 'hu', 'is', 'io', 'ig', 'in', 'ia', 'ie', 'iu', 'ik', 'ga', 'it', 'ja', 'jv', 'kn', 'kr', 'ks', 'kk', 'km', 'ki', 'rw', 'ky', 'kv', 'kg', 'ko', 'ku', 'kj', 'lo', 'la', 'lv', 'li', 'ln', 'lt', 'lu', 'lb', 'mk', 'mg', 'ms', 'ml', 'mt', 'gv', 'mi', 'mr', 'mh', 'mo', 'mn', 'na', 'nv', 'ng', 'ne', 'nd', 'se', 'no', 'nb', 'nn', 'ny', 'oc', 'oj', 'or', 'om', 'os', 'pi', 'pa', 'fa', 'pl', 'pt', 'ps', 'qu', 'rm', 'ro', 'rn', 'ru', 'sm', 'sg', 'sa', 'sc', 'gd', 'sr', 'sn', 'ii', 'sd', 'si', 'sk', 'sl', 'so', 'nr', 'st', 'es', 'su', 'sw', 'ss', 'sv', 'tl', 'ty', 'tg', 'ta', 'tt', 'te', 'th', 'bo', 'ti', 'to', 'ts', 'tn', 'tr', 'tk', 'tw', 'ug', 'uk', 'ur', 'uz', 've', 'vi', 'vo', 'wa', 'cy', 'wo', 'xh', 'ji', 'yo', 'za', 'zu'])
    ...
    def hash
      [created_date, last_modified_date, source, put_code, path, title, journal_title, short_description, citation, type, publication_date, external_ids, url, contributors, language_code, country, visibility].hash
    end
