...
RSpec.describe OrcidApi::AccessToken do
  subject(:service) { described_class.new(client_id: "id", client_secret: "secret") }
  ...
  before do
    ...
    stub_request(:post, "https://orcid.org/oauth/token")
      .with(
