...
# Unit tests for SwaggerClient::EmploymentV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmploymentV30' do
  before do
    # run before each test
    @instance = SwaggerClient::EmploymentV30.new
  end
  ...
  describe 'test an instance of EmploymentV30' do
    it 'should create an instance of EmploymentV30' do
      expect(@instance).to be_instance_of(SwaggerClient::EmploymentV30)
    end
  end
