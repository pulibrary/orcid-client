...
module SwaggerClient
  class FundingSummaryV30
    ...
    def hash
      [created_date, last_modified_date, source, title, external_ids, url, type, start_date, end_date, organization, visibility, put_code, path, display_index].hash
    end
