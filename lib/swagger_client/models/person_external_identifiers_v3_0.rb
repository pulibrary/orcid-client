...
module SwaggerClient
  class PersonExternalIdentifiersV30
    ...
    def self.swagger_types
      {
        ...
        :'external_identifier' => :'Array<PersonExternalIdentifierV30>',
        :'path' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'external-identifier')
        if (value = attributes[:'external-identifier']).is_a?(Array)
    ...
    def hash
      [last_modified_date, external_identifier, path].hash
    end
