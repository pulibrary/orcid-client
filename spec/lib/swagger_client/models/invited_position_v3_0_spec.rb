...
# Unit tests for SwaggerClient::InvitedPositionV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvitedPositionV30' do
  before do
    # run before each test
    @instance = SwaggerClient::InvitedPositionV30.new
  end
  ...
  describe 'test an instance of InvitedPositionV30' do
    it 'should create an instance of InvitedPositionV30' do
      expect(@instance).to be_instance_of(SwaggerClient::InvitedPositionV30)
    end
  end
