...
# Unit tests for SwaggerClient::MembershipSummaryV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MembershipSummaryV30' do
  before do
    # run before each test
    @instance = SwaggerClient::MembershipSummaryV30.new
  end
  ...
  describe 'test an instance of MembershipSummaryV30' do
    it 'should create an instance of MembershipSummaryV30' do
      expect(@instance).to be_instance_of(SwaggerClient::MembershipSummaryV30)
    end
  end
