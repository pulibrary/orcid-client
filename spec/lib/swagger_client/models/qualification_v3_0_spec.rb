...
# Unit tests for SwaggerClient::QualificationV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QualificationV30' do
  before do
    # run before each test
    @instance = SwaggerClient::QualificationV30.new
  end
  ...
  describe 'test an instance of QualificationV30' do
    it 'should create an instance of QualificationV30' do
      expect(@instance).to be_instance_of(SwaggerClient::QualificationV30)
    end
  end
