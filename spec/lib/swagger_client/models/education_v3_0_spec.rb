...
# Unit tests for SwaggerClient::EducationV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EducationV30' do
  before do
    # run before each test
    @instance = SwaggerClient::EducationV30.new
  end
  ...
  describe 'test an instance of EducationV30' do
    it 'should create an instance of EducationV30' do
      expect(@instance).to be_instance_of(SwaggerClient::EducationV30)
    end
  end
