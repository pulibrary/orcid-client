...
module SwaggerClient
  class FundingGroupV30
    attr_accessor :last_modified_date

    attr_accessor :external_ids

    attr_accessor :funding_summary
    ...
    def self.swagger_types
      {
        ...
        :'funding_summary' => :'Array<FundingSummaryV30>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'funding-summary')
        if (value = attributes[:'funding-summary']).is_a?(Array)
          self.funding_summary = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          funding_summary == o.funding_summary
    end
    ...
    def hash
      [last_modified_date, external_ids, funding_summary].hash
    end
