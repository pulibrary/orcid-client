...
# Unit tests for SwaggerClient::ResearcherUrlV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResearcherUrlV30' do
  before do
    # run before each test
    @instance = SwaggerClient::ResearcherUrlV30.new
  end
  ...
  describe 'test an instance of ResearcherUrlV30' do
    it 'should create an instance of ResearcherUrlV30' do
      expect(@instance).to be_instance_of(SwaggerClient::ResearcherUrlV30)
    end
  end
  ...
  describe 'test attribute "url_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
