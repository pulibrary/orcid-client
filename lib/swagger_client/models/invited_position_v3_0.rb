...
module SwaggerClient
  class InvitedPositionV30
    ...
    def hash
      [created_date, last_modified_date, source, put_code, path, department_name, role_title, start_date, end_date, organization, url, external_ids, display_index, visibility].hash
    end
