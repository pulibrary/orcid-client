...
# Unit tests for SwaggerClient::AffiliationSummaryV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AffiliationSummaryV30' do
  before do
    # run before each test
    @instance = SwaggerClient::AffiliationSummaryV30.new
  end
  ...
  describe 'test an instance of AffiliationSummaryV30' do
    it 'should create an instance of AffiliationSummaryV30' do
      expect(@instance).to be_instance_of(SwaggerClient::AffiliationSummaryV30)
    end
  end
