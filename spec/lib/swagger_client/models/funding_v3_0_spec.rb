...
# Unit tests for SwaggerClient::FundingV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FundingV30' do
  before do
    # run before each test
    @instance = SwaggerClient::FundingV30.new
  end
  ...
  describe 'test an instance of FundingV30' do
    it 'should create an instance of FundingV30' do
      expect(@instance).to be_instance_of(SwaggerClient::FundingV30)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["GRANT", "CONTRACT", "AWARD", "SALARY_AWARD"])
  ...
  describe 'test attribute "organization_defined_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
