...
module SwaggerClient
  class ResearchResourceV30
    ...
    def self.swagger_types
      {
        ...
        :'resource_item' => :'Array<ResearchResourceItemV30>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'resource-item')
        if (value = attributes[:'resource-item']).is_a?(Array)
    ...
    def hash
      [created_date, last_modified_date, source, proposal, resource_item, display_index, visibility, put_code, path].hash
    end
