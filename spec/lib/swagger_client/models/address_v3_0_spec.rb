...
# Unit tests for SwaggerClient::AddressV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddressV30' do
  before do
    # run before each test
    @instance = SwaggerClient::AddressV30.new
  end
  ...
  describe 'test an instance of AddressV30' do
    it 'should create an instance of AddressV30' do
      expect(@instance).to be_instance_of(SwaggerClient::AddressV30)
    end
  end
