...
module SwaggerClient
  class ExternalIDV30
    ...
    attr_accessor :external_id_normalized

    attr_accessor :external_id_normalized_error
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'external-id-normalized')
        self.external_id_normalized = attributes[:'external-id-normalized']
      end

      if attributes.has_key?(:'external-id-normalized-error')
        self.external_id_normalized_error = attributes[:'external-id-normalized-error']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          external_id_normalized == o.external_id_normalized &&
          external_id_normalized_error == o.external_id_normalized_error &&
    ...
    def hash
      [external_id_type, external_id_value, external_id_normalized, external_id_normalized_error, external_id_url, external_id_relationship].hash
    end
