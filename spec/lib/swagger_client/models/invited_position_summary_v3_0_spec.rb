...
# Unit tests for SwaggerClient::InvitedPositionSummaryV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvitedPositionSummaryV30' do
  before do
    # run before each test
    @instance = SwaggerClient::InvitedPositionSummaryV30.new
  end
  ...
  describe 'test an instance of InvitedPositionSummaryV30' do
    it 'should create an instance of InvitedPositionSummaryV30' do
      expect(@instance).to be_instance_of(SwaggerClient::InvitedPositionSummaryV30)
    end
  end
