...
module SwaggerClient
  class NameV30
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'given-names')
        self.given_names = attributes[:'given-names']
      end

      if attributes.has_key?(:'family-name')
        self.family_name = attributes[:'family-name']
      end
    ...
    def hash
      [created_date, last_modified_date, given_names, family_name, credit_name, source, visibility, path].hash
    end
