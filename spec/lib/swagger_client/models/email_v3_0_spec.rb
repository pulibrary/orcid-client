...
# Unit tests for SwaggerClient::EmailV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailV30' do
  before do
    # run before each test
    @instance = SwaggerClient::EmailV30.new
  end
  ...
  describe 'test an instance of EmailV30' do
    it 'should create an instance of EmailV30' do
      expect(@instance).to be_instance_of(SwaggerClient::EmailV30)
    end
  end
