...
# Unit tests for SwaggerClient::ServiceSummaryV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceSummaryV30' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceSummaryV30.new
  end
  ...
  describe 'test an instance of ServiceSummaryV30' do
    it 'should create an instance of ServiceSummaryV30' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceSummaryV30)
    end
  end
