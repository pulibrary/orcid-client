...
# Unit tests for SwaggerClient::FundingSummaryV30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FundingSummaryV30' do
  before do
    # run before each test
    @instance = SwaggerClient::FundingSummaryV30.new
  end
  ...
  describe 'test an instance of FundingSummaryV30' do
    it 'should create an instance of FundingSummaryV30' do
      expect(@instance).to be_instance_of(SwaggerClient::FundingSummaryV30)
    end
  end
