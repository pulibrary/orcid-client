...
module SwaggerClient
  class FundingV30
    ...
    attr_accessor :organization_defined_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'organization-defined-type')
        self.organization_defined_type = attributes[:'organization-defined-type']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['GRANT', 'CONTRACT', 'AWARD', 'SALARY_AWARD'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['GRANT', 'CONTRACT', 'AWARD', 'SALARY_AWARD'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          path == o.path &&
          type == o.type &&
          organization_defined_type == o.organization_defined_type &&
          title == o.title &&
    ...
    def hash
      [created_date, last_modified_date, source, put_code, path, type, organization_defined_type, title, short_description, amount, url, start_date, end_date, external_ids, contributors, organization, visibility].hash
    end
